          ...
          <article class="liquid-panel liquid-panel-interactive rounded-xl p-8 border border-white/20 transition-all duration-500">
            ...
            <div class="flex flex-col items-center text-center">
              <div class="relative flex flex-col items-center mb-6">
                <div class="w-32 h-32 sm:w-40 sm:h-40 rounded-xl liquid-panel-strong flex items-center justify-center overflow-hidden shadow-lg border border-white/30">
                  <img src="${CertificateImg}" alt="Backend Python Django Bootcamp Certificate" loading="lazy" class="w-full h-full object-contain rounded-xl" onerror="this.style.display='none'"/>
