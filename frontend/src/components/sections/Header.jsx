...
import { FaHome, FaUser, FaBriefcase, FaCode, FaTrophy, FaCertificate, FaProjectDiagram, FaEnvelope } from '../ui/Icons';
  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 w-full z-20 xl:hidden mobile-header" style={{letterSpacing: '0.03em', transform: 'translateZ(0)', willChange: 'backdrop-filter'}} role="banner">
        <div className="w-full liquid-panel-strong border-b border-white/10 relative">
          <div className="relative z-10">
            ...
            <div className="relative flex items-center gap-2 sm:gap-3">
              <div className="relative language-dropdown-container">
                <button
                  className="px-3 sm:px-4 py-2 liquid-panel border border-white/10 rounded-lg font-semibold text-xs sm:text-sm text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300"
                  aria-haspopup="true"
                  aria-expanded={isLanguageOpen}
                  aria-label={`Current language: ${getLanguageDisplay(currentLanguage)}. Click to change language`}
                  onClick={() => setIsLanguageOpen(!isLanguageOpen)}
